          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden 2xl:flex items-center space-x-4">
              <a 
                ...
                className="text-white px-6 py-2 body-text font-medium uppercase tracking-wide hover:opacity-70 transition-opacity flex items-center"
              >
          ...
          <div className={`fixed inset-0 bg-[#00452a] z-[9999] flex flex-col items-center justify-center 2xl:hidden ${isMenuClosing ? 'animate-fade-out' : 'animate-fade-in'}`}>
            ...
            <div className="text-center space-y-8">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white text-[20px] font-light uppercase tracking-wide hover:opacity-70 transition-opacity flex items-center justify-center"
                style={{ 
                  color: 'white !important',
                  textShadow: '0 0 2px rgba(0,0,0,0.5)'
                }}
